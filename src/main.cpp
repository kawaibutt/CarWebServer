...
const char* sta_ssid = "KCM_EE";
const char* sta_password = "ee123456";

//IPAddress sta_IP(192,168,8,1);
//IPAddress sta_gateway(192,168,8,1);
//IPAddress sta_subnet(255,255,255,0);
//String hostname = "ESP32 RC Car 01";

const char* ap_ssid = "RC_CAR_01";
